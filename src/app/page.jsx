...
const cardData = [
  { image: yek,title: '⭐⭐⭐⭐',description:'Cream Puffs' },
  { image: doo,title: '⭐⭐⭐⭐',description:'Buckwheat crêpe with avocado, ham and egg' },
  { image: seh,title: '⭐⭐⭐⭐⭐',description:'Chicken Thigh Confit with an Apricot Glaze' },
 
  { image: panj,title: '⭐⭐⭐⭐⭐',description:'Lemon and rosemary punch with lemon sorbet' },
...
export default function page() {
  ...
  return (
    <div className='bg-[#faf7f3] overflow-x-hidden'>
      <div className='relative'>
        <div className='bg-header w-[100%] h-[120vh] bg-cover bg-center'>
          ...
          <Box sx={{ 
            ...
            <Typography variant='h3' sx={{fontFamily:'cr',color:'white'}}>
              The unmistakable taste of the very best fruit.
            </Typography>
            <Typography variant='h1' sx={{fontFamily:'le',color:'white'}}>
              MAXIMUM ENJOYMENT: IT'S IN OUR NATURE.
            </Typography>
            <Box sx={{width:'100%'}}>
              <Button sx={{
                fontWeight:'bolder',
      ...
      <div data-aos="fade-up"
        data-aos-duration="3000" data-aos-offset="400" className='w-full min-h-[100vh] max-h-fit flex '>
      ...
      <div data-aos="fade-up"
        data-aos-offset="300"
        data-aos-duration="3000"  className='w-full min-h-[100vh] max-h-fit mt-[15%]'>
        <Cardthree />
      </div>
      <div className='relative'>
        <div data-aos="fade-up"
          ...
          className='bg-chery w-full min-h-[100vh] max-h-fit bg-center bg-cover'
        >
      ...
      <Box sx={{display:'flex',justifyContent:'center',alignItems:'center',textAlign:'center'}}>
        <Typography variant='h2' sx={{textAlign:'center',fontFamily:'le'}}>Follow us on Instagram @Saba_Asgarian_Web</Typography>
      </Box>
      <Footer/>
    </div>
  )
